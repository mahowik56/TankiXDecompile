...
namespace Platform.Library.ClientResources.Impl
{
	public class AssetBundleLoadSystem : ECSSystem
	{
		...
		private void CreateLoadingChannels(Entity assetBundleDatabaseEntity)
		{
			...
			int num = (assetBundleLoadingChannelsCountComponent.ChannelsCount = (assetBundleLoadingChannelsCountComponent.DefaultChannelsCount = Math.Max(1, Math.Min(SystemInfo.processorCount - 1, 4))));
