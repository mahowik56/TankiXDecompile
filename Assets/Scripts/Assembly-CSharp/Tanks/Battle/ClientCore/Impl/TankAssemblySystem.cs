...
namespace Tanks.Battle.ClientCore.Impl
{
	public class TankAssemblySystem : ECSSystem
	{
		...
		public void AssembleTank(NodeAddedEvent e, TankNode tank, [Context][JoinByTank] WeaponNode weapon)
		{
			...
			Transform transform2 = (transform.parent = tank.hullInstance.HullInstance.transform);
			UnityUtil.InheritAndEmplace(tank.tankCommonInstance.TankCommonInstance.transform, transform2);
			tank.tankPartPaintInstance.PaintInstance.transform.parent = transform2;
