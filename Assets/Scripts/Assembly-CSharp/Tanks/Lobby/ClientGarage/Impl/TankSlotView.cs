...
namespace Tanks.Lobby.ClientGarage.Impl
{
	public class TankSlotView : SlotView
	{
		...
		public NewModulesScreenSystem.SlotNode SlotNode { get; set; }
		...
		private void UpdateTooltip()
		{
			if (Locked)
			{
				string text = ((SlotNode.slotTankPart.TankPart != TankPartModuleType.TANK) ? turretLockedSlotText.Value : hullLockedSlotText.Value);
