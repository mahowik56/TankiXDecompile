Shader "KriptoFX/RFX4/Particle" {
	...
	SubShader {
		Tags { "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent" "RFX4" = "Particle" "RenderType" = "Transparent" }
		Pass {
			Tags { "IGNOREPROJECTOR" = "true" "QUEUE" = "Transparent" "RFX4" = "Particle" "RenderType" = "Transparent" }
			...
			// Keywords: BlendAdd VertLight_OFF FrameBlend_OFF SoftParticles_OFF Clip_OFF
