Shader "Battle/DiffuseToColorInterpolation" {
	Properties {
	...
	SubShader {
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp0.xyz = _ColorLerp.xxx * tmp1.xyz + tmp0.xyz;
		...
		Pass {
			...
			fout frag(v2f inp)
			{
                ...
                tmp2.xyz = _Color.xyz - tmp1.xyz;
                tmp1.xyz = _ColorLerp.xxx * tmp2.xyz + tmp1.xyz;
                tmp2 = tex2D(_BumpMap, inp.texcoord.xy);
