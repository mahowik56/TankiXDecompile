Shader "Alternativa/TankStandardTransparent" {
	Properties {
	...
	SubShader {
		LOD 300
		Tags { "PerformanceChecks" = "False" "QUEUE" = "Geometry+100" "RenderType" = "Opaque" }
		Pass {
			LOD 300
			Tags { "PerformanceChecks" = "False" "QUEUE" = "Geometry+100" "RenderType" = "Opaque" }
			ColorMask 0
		...
		Pass {
			Name "FORWARD"
			LOD 300
			Tags { "LIGHTMODE" = "FORWARDBASE" "PerformanceChecks" = "False" "QUEUE" = "Geometry+100" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
		...
		Pass {
			Name "FORWARD_DELTA"
			LOD 300
			Tags { "LIGHTMODE" = "FORWARDADD" "PerformanceChecks" = "False" "QUEUE" = "Geometry+100" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
		...
		Pass {
			Name "SHADOWCASTER"
			LOD 300
			Tags { "LIGHTMODE" = "SHADOWCASTER" "PerformanceChecks" = "False" "QUEUE" = "Geometry+100" "RenderType" = "Opaque" "SHADOWSUPPORT" = "true" }
			ZClip Off
			GpuProgramID 143966
			CGPROGRAM
			#pragma vertex vert
		...
		Pass {
			Name "META"
			LOD 300
			Tags { "LIGHTMODE" = "META" "PerformanceChecks" = "False" "QUEUE" = "Geometry+100" "RenderType" = "Opaque" }
			ZClip Off
			Cull Off
			GpuProgramID 250690
			CGPROGRAM
	...
	Fallback "VertexLit"
	CustomEditor "TankStandardTransparentShaderGUI"
}